...
// provide the md className keyword to indicate that you want something to happen when the screen has turned into a medium sized screen.
// provide the justify keyword to have the item move to the start or end of a container
        ...
        {isOpen ? (
          ...
          : (
            <Image
              ...
              className={theme === 'light' && 'filter invert'}
              // filter invert is inverting the colors on the symbol
            />
          )}
